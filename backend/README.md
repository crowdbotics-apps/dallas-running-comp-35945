...
## Project Structure
    ...
    ├── dallas_running_comp_35945  # Django project configurations
...
1. Clone this repo and `cd dallas_running_comp_35945`
...
2. Clone this repo and `cd dallas_running_comp_35945`
